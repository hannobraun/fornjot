...
#[derive(Debug)]
pub struct SurfaceVertices(BTreeMap<Index, Point<3>>);
...
impl SurfaceVertices {
    ...
    pub fn insert(&mut self, index: Index, vertex: Point<3>) {
...
mod tests {
    ...
    use crate::{geometry::isosurface::grid, math::Point};
    ...
    fn test_vertices() -> BTreeMap<grid::Index, Point<3>> {
