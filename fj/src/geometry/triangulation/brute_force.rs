...
mod tests {
    ...
    fn triangulate_should_handle_selected_triangle_being_outside_of_polygon() {
        ...
        // Outer border
        let p1 = Point::from_xy(2.0, -2.0);
        let p2 = Point::from_xy(3.0, 0.0);
        let p3 = Point::from_xy(2.0, 2.0);
        polygon.insert_chain(&[p0, p1, p2, p3]);

        // Inner border
        let p1 = Point::from_xy(1.0, 0.5);
        let p2 = Point::from_xy(2.0, 0.0);
        let p3 = Point::from_xy(1.0, -0.5);
        polygon.insert_chain(&[p0, p1, p2, p3]);
